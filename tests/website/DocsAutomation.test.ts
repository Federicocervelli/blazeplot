...
describe("docs automation", () => {
  ...
  test("README/API/benchmark generated docs are fresh", () => {
    const readme = readFileSync("README.md", "utf8");
    expect(readme).toContain("<!-- README_PERFORMANCE_START -->");
    expect(readme).toContain("<!-- README_PERFORMANCE_END -->");

    const benchmarks = readFileSync("docs/benchmarks.md", "utf8");
    expect(benchmarks).toContain("generated by scripts/generate-readme-docs.js from benchmarks/latest.json");
    expect(benchmarks).toContain("do not edit benchmark numbers by hand");
