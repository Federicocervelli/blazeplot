...
| **Export helpers** | `chart.screenshot()` composites WebGL output with built-in DOM/SVG overlays. `blazeplot/data` and `blazeplot/export` provide lightweight CSV/JSON data export and pure transform helpers. |
...
| `blazeplot/export` | Screenshot, CSV/JSON data, download, and clipboard helpers. |
