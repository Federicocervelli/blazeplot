    ...
    return html`
      <header class="sticky top-0 z-50 flex flex-col gap-2 border-b border-[#222] bg-[#0a0a0a] px-3 py-2 select-none sm:flex-row sm:items-center sm:justify-between sm:px-4">
        ...
        <nav class="flex w-full items-center gap-2 overflow-x-auto pb-0.5 text-[12px] sm:w-auto sm:overflow-visible sm:pb-0">
          ...
          <a href="https://github.com/Federicocervelli/blazeplot" target="_blank" rel="noreferrer" class="flex shrink-0 items-center gap-1.5 whitespace-nowrap leading-none text-[#888] no-underline hover:text-[#fc4a05] px-2 py-1 border border-[#222] hover:border-[#fc4a05] rounded">
          ...
          <a href="https://www.npmjs.com/package/blazeplot" target="_blank" rel="noreferrer" class="flex shrink-0 items-center gap-1.5 whitespace-nowrap leading-none text-[#888] no-underline hover:text-[#fc4a05] px-2 py-1 border border-[#222] hover:border-[#fc4a05] rounded">
            <span class="inline-flex h-3.5 w-3.5 shrink-0 items-center justify-center">
              <svg class="block h-full w-full" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
          ...
          <a href="https://cervelli.dev" target="_blank" rel="noreferrer" class="flex shrink-0 items-center gap-1.5 whitespace-nowrap leading-none text-[#888] no-underline hover:text-[#fc4a05] px-2 py-1 border border-[#222] hover:border-[#fc4a05] rounded">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><path d="M2 12h20"/><path d="M12 2a15.3 15.3 0 0 1 0 20"/><path d="M12 2a15.3 15.3 0 0 0 0 20"/></svg>
            <span>Portfolio</span>
          </a>
        </nav>
      </header>
