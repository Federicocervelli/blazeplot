...
export class BlazeplotTopbar extends LitElement {
  ...
  override render(): TemplateResult {
    return html`
      <header class="sticky top-0 z-50 flex items-center justify-between gap-2 border-b border-[#222] bg-[#0a0a0a] px-3 py-2 select-none sm:px-4">
        <div class="flex items-center gap-2">
          ${this.section === "docs" || this.section === "previews" ? html`
            <button type="button" class="inline-flex h-8 w-8 shrink-0 items-center justify-center rounded border border-[#222] text-[#888] hover:border-[#fc4a05] hover:text-[#fc4a05] md:hidden" aria-label=${this.section === "docs" ? "Open docs navigation" : "Open preview navigation"} @click=${this.openSectionNavigation}>
        ...
        <nav class="flex w-auto min-w-0 items-center gap-2 overflow-x-auto pb-0 text-[12px] sm:overflow-visible">
          <a href=${appHref(`docs/${DOC_PAGES[0]?.slug ?? "examples"}`)} class="flex shrink-0 items-center gap-0 whitespace-nowrap leading-none text-[#888] no-underline hover:text-[#fc4a05] px-2 py-1 border border-[#222] hover:border-[#fc4a05] rounded sm:gap-1.5">
            ...
            <span class="hidden h-3.5 items-center leading-none sm:inline-flex" style="position: relative; top: 2px;">Docs</span>
          </a>
          <a href=${appHref("previews")} class="flex shrink-0 items-center gap-0 whitespace-nowrap leading-none text-[#888] no-underline hover:text-[#fc4a05] px-2 py-1 border border-[#222] hover:border-[#fc4a05] rounded sm:gap-1.5">
            ...
            <span class="hidden h-3.5 items-center leading-none sm:inline-flex" style="position: relative; top: 2px;">Previews</span>
          </a>
          <a href="https://github.com/Federicocervelli/blazeplot" target="_blank" rel="noreferrer" aria-label="BlazePlot on GitHub, ${this.formatGithubStars()} stars" class="flex shrink-0 items-center gap-0 whitespace-nowrap leading-none text-[#888] no-underline hover:text-[#fc4a05] px-2 py-1 border border-[#222] hover:border-[#fc4a05] rounded sm:gap-1.5">
            ...
            <span class="hidden h-3.5 items-center leading-none tabular-nums sm:inline-flex" style="position: relative; top: 2px;">${this.formatGithubStars()}</span>
          </a>
          ...
          <a href="https://cervelli.dev" target="_blank" rel="noreferrer" aria-label="Portfolio" class="flex shrink-0 items-center gap-0 whitespace-nowrap leading-none text-[#888] no-underline hover:text-[#fc4a05] px-2 py-1 border border-[#222] hover:border-[#fc4a05] rounded sm:gap-1.5">
            ...
            <span class="hidden h-3.5 items-center leading-none sm:inline-flex" style="position: relative; top: 2px;">Portfolio</span>
          </a>
        </nav>
      </header>
    `;
